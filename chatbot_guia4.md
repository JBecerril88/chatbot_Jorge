...
1.  **Problema:** $$\int x^2 \cos(2x) \, dx$$
    ...
    **Respuesta:** $$\boxed{\frac{1}{2}x^2 \sin(2x) + \frac{1}{2}x\cos(2x) - \frac{1}{4}\sin(2x) + C}$$
...
2.  **Problema:** $$\int x^2 e^{-2x} \, dx$$
    ...
    **Respuesta:** $$\boxed{-\frac{1}{4}e^{-2x}(2x^2 + 2x + 1) + C}$$
...
3.  **Problema:** $$\int x^2 \ln(2x) \, dx$$
    ...
    **Respuesta:** $$\boxed{\frac{x^3}{3}\ln(2x) - \frac{x^3}{9} + C}$$
...
4.  **Problema:** $$\int x e^{-\frac{x}{2}} \, dx$$
    ...
    **Respuesta:** $$\boxed{-2(x+2)e^{-\frac{x}{2}} + C}$$
...
5.  **Problema:** $$\int x^2 \sin(x) \, dx$$
    ...
    **Respuesta:** $$\boxed{-x^2 \cos(x) + 2x \sin(x) + 2\cos(x) + C}$$
...
6.  **Problema:** $$\int e^x \sin(x) \, dx$$
    ...
    **Paso:** Sustituyendo de vuelta y resolviendo para la integral
    $$\int e^x \sin(x) \, dx = \frac{e^x(\sin(x) - \cos(x))}{2} + C$$

    **Respuesta:** $$\boxed{\frac{e^x(\sin(x) - \cos(x))}{2} + C}$$
...
7.  **Problema:** $$\int \arcsin(x) \, dx$$
    ...
    **Respuesta:** $$\boxed{x\arcsin(x) + \sqrt{1-x^2} + C}$$
...
9.  **Problema:** $$\int \frac{1}{x^2 + x - 2} \, dx$$
    ...
    **Respuesta:** $$\boxed{\frac{1}{3}\ln\left|\frac{x-1}{x+2}\right| + C}$$
...
10. **Problema:** $$\int \frac{1}{x^3(1-x)} \, dx$$
    ...
    **Respuesta:** $$\boxed{\ln\left|\frac{x}{1-x}\right| - \frac{1}{x} - \frac{1}{2x^2} + C}$$

11. **Problema:** $$\int \frac{x^2 + 1}{x^2 - 1} \, dx$$

    **Solución:**

    **Pista:** El grado del numerador es igual al grado del denominador. ¿Qué debes hacer primero? (División polinomial).

    **Paso:** Integrar
    $$\int \frac{x^2 + 1}{x^2 - 1} \, dx = x + \ln\left|\frac{x-1}{x+1}\right| + C$$

    **Respuesta:** $$\boxed{x + \ln\left|\frac{x-1}{x+1}\right| + C}$$
...
12. **Problema:** $$\int \frac{x^2 - 2}{x(x^2 + 2)} \, dx$$
    ...
    **Respuesta:** $$\boxed{\ln\left|\frac{x^2 + 2}{x}\right| + C}$$
...
13. **Problema:** $$\int \frac{3x + 5}{x^2 - x - 2} \, dx$$
    ...
    **Respuesta:** $$\boxed{\frac{11}{3}\ln|x-2| - \frac{2}{3}\ln|x+1| + C}$$
...
14. **Problema:** $$\int \frac{2x^2 + 3x + 1}{(x-1)(x^2+4)} \, dx$$
    ...
    **Respuesta:** $$\boxed{\frac{6}{5}\ln|x-1| + \frac{2}{5}\ln(x^2+4) + \frac{19}{10}\arctan\left(\frac{x}{2}\right) + C}$$
...
15. **Problema:** $$\int \frac{\sec^2 x}{\tan^2 x+3\tan x+2} \, dx$$
    ...
    **Respuesta:** $$\boxed{\ln\left|\frac{\tan x+1}{\tan x+2}\right| + C}$$
